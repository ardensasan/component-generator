...
import { addEmployee, closeDialog, updateEmployee } from "../../../components/Employee/action";
...
const FormDialog = ({ fields, defaultFieldValues, dialog }: Form) => {
  ...
  const handleSave = () => {
    if(fieldValues.hasOwnProperty("_id")) return dispatch(updateEmployee(fieldValues))
    dispatch(addEmployee(fieldValues));
  };
  useEffect(() => {
